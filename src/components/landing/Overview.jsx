export default function Overview() {
  return (
    <section id="overview" className="relative w-full py-32 flex flex-col items-center justify-center bg-black overflow-hidden">
      
      <div className="text-center mb-16 z-10 px-4">
        <h2 className="text-[clamp(2.5rem,6vw,5rem)] font-display font-medium leading-[1.1] tracking-tight text-white flex flex-col">
          <span className="text-white/80">Unlock your</span>
          <span>best financial clarity</span>
        </h2>
      </div>

      <div className="relative w-full max-w-6xl px-4 z-10 group cursor-pointer">
        <figure className="relative w-full aspect-video rounded-3xl overflow-hidden bg-[#111] border border-white/10 shadow-[0_0_50px_rgba(0,204,255,0.1)] transition-transform duration-500 group-hover:scale-[1.02]">
          {/* Using a placeholder image that resembles a dashboard preview */}
          <img 
