    ...
    <>
      ...
      <div className="min-h-screen bg-black pt-[100px] pb-32 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-10 z-10 flex flex-col gap-8">
          <div>
            <h1 className="text-4xl font-display font-medium text-white tracking-tight mb-2">Deals & Pipelines</h1>
            <p className="text-white/60 text-base">Track deal stages, manage incoming opportunities, and analyze pipeline performance.</p>
          </div>
